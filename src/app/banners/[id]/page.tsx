      ...
      <div className="page-container section-spacing padding-top-zero">
        <div className="bg-white rounded-lg border border-brand-q p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <dl className="space-y-3">
                ...
                <div>
                  ...
                  <dd className="text-base text-brand-l capitalize">{banner.MediaType || 'Image'}</dd>
                </div>
            ...
            <div>
              <h3 className="heading-6 mb-4">Scheduling and Status</h3>
              <dl className="space-y-3">
                <div>
                  <dt className="text-small font-medium text-brand-k">Status</dt>
                  <dd className={`text-base font-medium ${banner.IsActive ? 'text-brand-b' : 'text-brand-f'
                    }`}>
          ...
          {banner.UploadedFile && (
            <div className="mt-8 pt-6 border-t border-brand-q">
              <h3 className="heading-6 mb-4">Uploaded File</h3>
              <dl className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  <dt className="text-small font-medium text-brand-k">File URL</dt>
                  <dd className="text-base text-brand-l break-all">{banner.UploadedFile.FileUrl}</dd>
                </div>
              </dl>
            </div>
          )}

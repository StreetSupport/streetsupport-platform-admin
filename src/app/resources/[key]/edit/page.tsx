...
const RESOURCE_FILE_ACCEPT_STRING = 'application/pdf,application/msword,application/vnd.ms-excel,application/vnd.ms-powerpoint,audio/mpeg,video/mp4,application/zip,image/jpeg,image/jpg,image/png';
